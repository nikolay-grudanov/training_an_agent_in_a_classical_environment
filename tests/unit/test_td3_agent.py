...
class TestTD3Agent:
    ...
    def test_agent_initialization(self, td3_config: TD3Config, mock_env: Mock) -> None:
        """Тест инициализации TD3 агента."""
        with patch("src.agents.td3_agent.make_vec_env"), \
    ...
    def test_discrete_action_space_validation(self, td3_config: TD3Config) -> None:
        ...
        with patch("src.utils.set_seed"), \
            ...
            with pytest.raises(ValueError, match="TD3 поддерживает только непрерывные пространства действий"):
    ...
    def test_normal_action_noise_creation(self, mock_noise_class: Mock, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_ou_action_noise_creation(self, mock_noise_class: Mock, td3_config: TD3Config, mock_env: Mock) -> None:
        ...
        with patch("src.agents.td3_agent.make_vec_env"), \
            ...
            assert call_args[1]["sigma"] == 0.3

    def test_no_action_noise_creation(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    @patch("src.agents.td3_agent.get_linear_fn")
    def test_learning_rate_schedule_creation(self, mock_schedule: Mock, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_exponential_learning_rate_schedule(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    @patch("src.agents.td3_agent.TD3")
    def test_model_creation(self, mock_td3_class: Mock, td3_config: TD3Config, mock_env: Mock) -> None:
        ...
        with patch("src.agents.td3_agent.make_vec_env"), \
            ...
            assert call_kwargs["learning_rate"] == td3_config.learning_rate
    ...
    def test_train_method(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_predict_method(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_predict_untrained_model(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_save_and_load_model(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_get_model_info(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_reset_model(self, td3_config: TD3Config, mock_env: Mock) -> None:
        """Тест сброса модели."""
        with patch("src.agents.td3_agent.make_vec_env"), \
             patch("src.agents.td3_agent.TD3"), \
             patch("src.utils.set_seed"), \
            ...
            with patch.object(agent.vec_env, "close"):
                agent.reset_model()
            
            assert agent.is_trained is False
            assert agent.training_result is None

    def test_update_noise_schedule_normal(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_update_noise_schedule_ou(self, td3_config: TD3Config, mock_env: Mock) -> None:
    ...
    def test_callbacks_setup(self, td3_config: TD3Config, mock_env: Mock) -> None:
