...
class TestEvaluator:
    ...
    def test_evaluate_agent_basic(
        self, evaluator: Evaluator, mock_agent: MockAgent
    ) -> None:
    ...
    def test_export_to_dataframe_multiple(self, evaluator: Evaluator) -> None:
        ...
        assert all(
            col in df.columns for col in ["mean_reward", "std_reward", "success_rate"]
        )
    ...
    def test_confidence_intervals(
        self, mock_env: MockEnv, mock_agent: MockAgent, confidence_level: float
    ) -> None:
