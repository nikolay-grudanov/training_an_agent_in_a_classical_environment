...
class TestPlottingFunctions:
    ...
    def sample_training_data(self) -> dict:
        ...
        episode_lengths = 100 + 50 * np.sin(timesteps / 200) + 10 * np.random.randn(1000)
    ...
    def test_plot_learning_curve_with_confidence(self, sample_training_data: dict) -> None:
    ...
    def test_plot_learning_curve_invalid_backend(self, sample_training_data: dict) -> None:
    ...
    def test_plot_multiple_runs(self, sample_training_data: dict) -> None:
        ...
        for i, algorithm in enumerate(["PPO", "A2C", "SAC"]):
            ...
            rewards = sample_training_data["rewards"] + noise_factor * np.random.randn(1000)
            runs_data[algorithm] = {
                "timesteps": sample_training_data["timesteps"],
                "reward": rewards,
            }
