...
def baseline_config():
    ...
    return RLConfig(
        ...
        algorithm=AlgorithmConfig(
            name="PPO", learning_rate=3e-4, n_steps=2048, batch_size=64
        ),
...
class TestExperimentInitialization:
    ...
    def test_valid_initialization(
        self, baseline_config, variant_config, temp_output_dir
    ):
    ...
    def test_invalid_environment_mismatch(
        self, baseline_config, invalid_variant_config, temp_output_dir
    ):
    ...
    def test_identical_configurations(
        self, baseline_config, identical_config, temp_output_dir
    ):
...
class TestResultsManagement:
    ...
    def test_add_invalid_config_type(
        self, baseline_config, variant_config, temp_output_dir
    ):
    ...
    def test_compare_results_incomplete(
        self, baseline_config, variant_config, temp_output_dir
    ):
...
class TestStatusAndSummary:
    ...
    def test_get_status_with_duration(
        self, baseline_config, variant_config, temp_output_dir
    ):
...
def test_experiment_reproducibility(
    seed, baseline_config, variant_config, temp_output_dir
):
