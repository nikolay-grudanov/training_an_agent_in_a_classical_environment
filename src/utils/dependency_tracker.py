...
class DependencyTracker:
    ...
    def __init__(self, project_root: Optional[Union[str, Path]] = None):
        ...
        logger.info(
            f"Инициализирован DependencyTracker для проекта: {self.project_root}"
        )
    ...
    def get_package_manager_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            managers["conda"] = {"available": True, "version": result.stdout.strip()}
            ...
            try:
                ...
                managers["conda"]["active_env"] = env_info.get(
    ...
    def compare_snapshots(
        ...
        if (
            snapshot1["system"]["python"]["version"]
            != snapshot2["system"]["python"]["version"]
        ):
    ...
    def export_requirements(
        self, format_type: str = "pip", output_file: Optional[Union[str, Path]] = None
    ) -> str:
    ...
    def _export_conda_environment(self, output_file: Optional[Union[str, Path]]) -> str:
        ...
        try:
            result = subprocess.run(
                ["conda", "env", "export"], capture_output=True, text=True, check=True
            )
    ...
    def _export_poetry_requirements(
        self, output_file: Optional[Union[str, Path]]
    ) -> str:
...
def create_experiment_snapshot(
    experiment_id: str, project_root: Optional[Union[str, Path]] = None
) -> Dict[str, Any]:
    ...
    snapshot_name = (
        f"experiment_{experiment_id}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
    )
...
def validate_environment_for_experiment(
    reference_snapshot: str, project_root: Optional[Union[str, Path]] = None
) -> bool:
