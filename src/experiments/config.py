...
class Configuration:
    ...
    _SUPPORTED_ALGORITHMS: Set[str] = field(
        default_factory=lambda: {"PPO", "A2C", "SAC", "TD3"}, init=False, repr=False
    )
    ...
    def validate(self) -> None:
        ...
        if not isinstance(self.evaluation_frequency, int):
            ...
            errors.append("evaluation_frequency не может быть больше training_steps")
    ...
    def get_differences(self, other: "Configuration") -> Dict[str, Dict[str, Any]]:
        ...
        for field_name in fields_to_compare:
            ...
            if self_value != other_value:
                differences[field_name] = {"self": self_value, "other": other_value}
    ...
    def merge(self, other: "Configuration") -> "Configuration":
        ...
        if not isinstance(other, Configuration):
            raise TypeError(
                "Объединение возможно только с другим объектом Configuration"
            )
...
def compare_configs(config1: Configuration, config2: Configuration) -> Dict[str, Any]:
